...
{
    public class PowerToysApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            builder.Services.AddSingleton<IPackageManifestReader, PowerToysPackageManifestReader>();

            builder.Services.AddUnique<IPowerToyService, PowerToyService>();
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Power Toys Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<PowerToysOperationSecurityFilter>();
            });
        }

        public class PowerToysOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("PowerToys.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
